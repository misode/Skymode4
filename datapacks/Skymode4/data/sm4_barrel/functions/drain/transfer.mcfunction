...
execute at @e[tag=barrelFlow,tag=barrelSteel,limit=1,distance=..1.1] positioned ~ ~-1 ~ run scoreboard players set @e[sort=nearest,limit=1,tag=barrel] barrelContent 38
