...
execute if entity @e[tag=barrelAlloy] run function sm4_barrel:drain/check_alloy
...
execute if entity @e[tag=barrelCasting] run function sm4_barrel:drain/check_casting
...
execute if entity @e[tag=barrelDraining] run function sm4_barrel:drain/check_draining
