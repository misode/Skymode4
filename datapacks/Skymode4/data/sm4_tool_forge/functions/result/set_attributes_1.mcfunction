...
execute if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:diamond_sword",Count:1b,tag:{Steel:1b}}]} run scoreboard players operation @s toolSpeed += #steelTool toolSpeed
...
execute if block ~ ~ ~ dropper{Items:[{Slot:4b,id:"minecraft:diamond_sword",Count:1b,tag:{Steel:1b}}]} run scoreboard players operation @s toolSpeed += #steelRod toolSpeed
...
execute if block ~ ~ ~ dropper{Items:[{Slot:4b,id:"minecraft:diamond_sword",Count:1b,tag:{Steel:1b}}]} run scoreboard players operation @s toolDurability += #steelRod toolDurability
