...
summon armor_stand{NoGravity:1,Small:1,Marker:1,Fire:200000,ArmorItems:[{},{},{},{Count:1,id:"minecraft:crafting_table"}],Invulnerable:1,Invisible:1,DisabledSlots:2039552,Tags:[crafter,GM4_noEdit]} 4.5 63.1 -0.5
