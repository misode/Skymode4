...
execute if entity @s[scores={barrelContent=38}] if entity @e[tag=barrelDraining,scores={barrelContent=0}] run function skymode4:modules/barrel/drain/self
...
execute if entity @s[scores={barrelContent=38}] if entity @e[tag=barrelDraining,scores={barrelContent=38}] run function skymode4:modules/barrel/drain/self
