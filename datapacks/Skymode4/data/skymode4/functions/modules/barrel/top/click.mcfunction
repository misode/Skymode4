...
scoreboard players remove @s[tag=!barrelCast,scores={barrelContent=11,barrelCount=1..}] barrelCount 1
scoreboard players remove @s[tag=!barrelCast,scores={barrelContent=15,barrelCount=1..}] barrelCount 1
