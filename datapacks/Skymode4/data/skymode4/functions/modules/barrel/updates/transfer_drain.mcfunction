...
execute at @e[tag=barrelFlow,limit=1,distance=..1.1] positioned ~ ~-1 ~ run scoreboard players set @e[sort=nearest,limit=1,tag=barrel] barrelCount 1
...
execute at @e[tag=barrelFlow,limit=1,distance=..1.1] positioned ~ ~-1 ~ run say hi @e[sort=nearest,limit=1,tag=barrel]
