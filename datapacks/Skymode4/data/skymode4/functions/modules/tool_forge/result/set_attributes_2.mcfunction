...
execute if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:diamond_sword",Count:1b,tag:{Steel:1b}}]} run scoreboard players operation @s toolDamage += #steelTool toolDamage
...
execute if block ~ ~ ~ dropper{Items:[{Slot:4b,id:"minecraft:diamond_sword",Count:1b,tag:{Steel:1b}}]} run scoreboard players operation @s toolDamage += #steelBinding toolDamage
...
execute if block ~ ~ ~ dropper{Items:[{Slot:7b,id:"minecraft:diamond_sword",Count:1b,tag:{Steel:1b}}]} run scoreboard players operation @s toolDamage += #steelRod toolDamage
...
execute if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:diamond_sword",Count:1b,tag:{Steel:1b}}]} run scoreboard players operation @s toolDurability += #steelTool toolDurability
...
execute if block ~ ~ ~ dropper{Items:[{Slot:4b,id:"minecraft:diamond_sword",Count:1b,tag:{Steel:1b}}]} run scoreboard players operation @s toolDurability += #steelBinding toolDurability
...
execute if block ~ ~ ~ dropper{Items:[{Slot:7b,id:"minecraft:diamond_sword",Count:1b,tag:{Steel:1b}}]} run scoreboard players operation @s toolDurability += #steelRod toolDurability
