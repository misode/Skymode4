...
execute if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:diamond_sword",Count:1b,tag:{Brass:1b}}]} run function skymode4:modules/tool_forge/result/brass_sword
execute if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:diamond_sword",Count:1b,tag:{Steel:1b}}]} run function skymode4:modules/tool_forge/result/steel_sword
