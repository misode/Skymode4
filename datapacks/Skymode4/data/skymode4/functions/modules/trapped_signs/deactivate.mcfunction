execute if block ~ ~ ~ #minecraft:signs run fill ~ ~-2 ~ ~ ~-2 ~ redstone_wire[power=0] replace redstone_wire[power=1]
execute if block ~ ~ ~ #minecraft:signs run fill ~ ~-1 ~1 ~ ~ ~-1 redstone_wire[power=0] replace redstone_wire[power=1]
execute if block ~ ~ ~ #minecraft:signs run fill ~ ~-2 ~ ~ ~-2 ~ redstone_wire[power=0] replace redstone_wire[power=1]
execute if block ~ ~ ~ #minecraft:signs run fill ~ ~-1 ~1 ~ ~ ~-1 redstone_wire[power=0] replace redstone_wire[power=1]
execute if block ~ ~ ~ #minecraft:signs run fill ~1 ~-1 ~ ~-1 ~ ~ redstone_wire[power=0] replace redstone_wire[power=1]
