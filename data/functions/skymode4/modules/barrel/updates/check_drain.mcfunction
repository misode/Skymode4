...
scoreboard players set @s[score_barrelContent_min=26,score_barrelContent=26,tag=barrelSeared] barrelDrain 2
...
execute @s[score_barrelContent_min=26,score_barrelContent=26,score_barrelCount_min=1] ~ ~ ~ summon armor_stand ~ ~1000 ~ {Invisible:1,NoGravity:1,Marker:1,Tags:[barrelFlow,barrelBronze],ArmorItems:[{},{},{},{id:stone_hoe,Count:1,Damage:71s,tag:{Unbreakable:1b}}]}
