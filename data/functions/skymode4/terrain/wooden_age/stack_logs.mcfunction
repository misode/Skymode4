setblock 1 92 -3 structure_block 0 destroy {ignoreEntities:0b,posX:0,mode:"LOAD",posY:-32,posZ:0,showair:0b,name:"terrain/wooden_age/stack_logs",showboundingbox:0b}
setblock 1 93 -3 redstone_block 0 destroy
fill 1 92 -3 1 93 -3 air 0
